...
- most of the participants stick to their prior beliefs - which you can see in the light green rectangles. For example, 84 students who believed that male bias does not exist (indicated by 2), after seeing evidence that supported the existence of male bias, they still believed the same 
- Another example: 15 people that believed that male bias does not exist indicated by 2, whereas after reading evidence that supperted the existence of male bias that they updated their belief in line with the evdence 
...
* First, student teachers evaluate evidence based on their beliefs. Even if teachers engage with evidence it does not automatically lead to informed decisions. So one take home message could be that we have to support student teachers in evaluating evidence 
...
- while we presented one study on the topic of male bias thomm and colleagues as well as futterleib and collegues presented multiple results
