...
* First, student teachers evaluate evidence based on their beliefs. Even if teachers engage with evidence it does not automatically lead to informed decisions. So one take home message could be that we have to support student teachers in evaluating evidence to reduce the influence of prior beliefs
...
- However, there is a difference between nd our study and previous study: our participants did not change their belief direction
- it also leads to the question what degree of updating is adequate? because we don't want students to blindly trust research - do we? 
