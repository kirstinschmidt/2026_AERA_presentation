...
- when thinking of teachers' beliefs about educational research, previous research shows that educational misconceptions and myths are widespread and hard to debunk One explanation might be the so-called confirmation bias 
...
- But surprisingly two studies found that student teachers update their beliefs in line with the evidence although evidence contradicted their beliefs
...
- hence, we asked whether
   ...
   + 3) and to what extent the in(congruency) of belief and evidence influences student teachers certainty in their beliefs. As more research on ConfBias more broadly shows that the more certain people are, the more likely they'll stick to it even after receiving information that contradicts it
...
- the experiment was framed by the topic gender-sensitive language in school. In other words, the leading question was whether the **usage of generic masculine leads to a disproportionate association with male students (male bias)** among teachers
...
- Regarding RQ2 you can see that in both experimental groups most of the participants stick to their prior beliefs - which you can see in the light green rectangles. For example, 84 students who believed that male bias does not exist (indicated by 2), believed the same after seeing belief-incogruent evidence
- Another example: 15 people that believed that male bias does not exist indicated by 2, whereas after reading belief-incongruent evidence that they believed in the existence of male bias
...
* First, student teachers evaluate evidence based on their beliefs. Even if teachers engage with evidence it does not automaticallly mean this does not automatically lead to informed decisions So one take home message could be that we have to support student teachers in evalauting evidence 

* However, they do not stick to their beliefs without any reflection. Because they update their certainty
...
- other influencing factors might also exist, e.g. context. There might be beliefs that are harder to debunk than others. 
